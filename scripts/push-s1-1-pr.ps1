# Push cursor/s1-1-core-tasks-tests and open a pre-filled PR page.
# Run in PowerShell: .\scripts\push-s1-1-pr.ps1
$ErrorActionPreference = "Stop"

$repoRoot   = "C:\Apps\KrwnOS"
$branch     = "cursor/s1-1-core-tasks-tests"
$baseBranch = "cursor/mission-whitepaper-obligations"
$repoSlug   = "KrwnOS/krwnos"
$title      = "test(tasks): add service and repo coverage for core.tasks"
$bodyPath   = "docs/agent-briefs/S1.1-PR-body.md"
