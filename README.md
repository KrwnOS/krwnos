...
**Миссия.** KrwnOS даёт сообществам **собственную программную
юрисдикцию**: фидуциарий, который **служит** Суверену и конституции
State, а не подменяет их. Доверие — через **открытый код**, **аудируемый**
каталог расширений и право **видеть, проверять, форкать и уносить**
данные; машинный аудит и ИИ — **помощники**, не замена ответственности.
**Обязательства перед сообществом** и формулировки «на наследие» —
[`docs/WHITEPAPER.md`](./docs/WHITEPAPER.md), раздел **«Миссия»**.
